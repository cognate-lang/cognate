...
#define _1e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[0]->range.end))
    __ = ast_single(let, (void*) lowercase(_1));
#undef _1e
#undef _1s
#undef _1
#undef _0e
...
#define _2e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[1]->range.end))
    __ = ast_single(def, (void*) lowercase(_2));
#undef _2e
#undef _2s
#undef _2
#undef _0e
...
#define _3e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[2]->range.end))
    __ = ast_single(identifier, (void*) lowercase(_3));
#undef _3e
#undef _3s
#undef _3
#undef _0e
...
#define _4e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[3]->range.end))
    __ = ast_single(literal,    (void*) mk_lit(symbol, _4));
#undef _4e
#undef _4s
#undef _4
#undef _0e
...
static void pcc_action_token_5(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
...
#define _5e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[4]->range.end))
    __ = ast_single(literal,    (void*) mk_lit(string, _5));
#undef _5e
#undef _5s
#undef _5
#undef _0e
...
static void pcc_action_token_6(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
...
#define _6e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[5]->range.end))
    __ = ast_single(literal,    (void*) mk_lit(number, _6));
#undef _6e
#undef _6s
#undef _6
#undef _0e
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_token(pcc_context_t *ctx) {
    ...
    pcc_value_table__clear(ctx->auxil, &chunk->values);
    {
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0002;
        {
            ...
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_formal, &chunk->thunks, NULL)) goto L0002;
            {
                ...
                for (i = 0;; i++) {
                    const size_t p = ctx->cur;
                    const size_t n = chunk->thunks.len;
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_informal, &chunk->thunks, NULL)) goto L0009;
                    if (ctx->cur == p) break;
                    continue;
                L0009:;
                    ctx->cur = p;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_0, 1, 6);
    ...
    L0002:;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0010;
        {
            const size_t p = ctx->cur;
            size_t q;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_formal, &chunk->thunks, NULL)) goto L0010;
            {
                int i;
                for (i = 0;; i++) {
                    const size_t p = ctx->cur;
                    const size_t n = chunk->thunks.len;
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_informal, &chunk->thunks, NULL)) goto L0017;
                    if (ctx->cur == p) break;
                    continue;
                L0017:;
                    ctx->cur = p;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_1, 1, 6);
    ...
    L0010:;
        ...
        ctx->cur++;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_expression, &chunk->thunks, &(chunk->values.buf[0]))) goto L0018;
        if (
            pcc_refill_buffer(ctx, 1) < 1 ||
            ctx->buffer.buf[ctx->cur] != ')'
        ) goto L0018;
        ctx->cur++;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_2, 1, 6);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->cur;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0018:;
        ...
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        {
            const size_t p = ctx->cur;
            size_t q;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_formal, &chunk->thunks, NULL)) goto L0019;
            {
                int i;
                for (i = 0;; i++) {
                    const size_t p = ctx->cur;
                    const size_t n = chunk->thunks.len;
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_informal, &chunk->thunks, NULL)) goto L0020;
                    if (ctx->cur == p) break;
                    continue;
                L0020:;
                    ctx->cur = p;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_3, 1, 6);
    ...
    L0019:;
        ...
        ctx->cur++;
        {
            ...
            size_t q;
            {
                ...
                for (i = 0;; i++) {
                    const size_t p = ctx->cur;
                    const size_t n = chunk->thunks.len;
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_informal, &chunk->thunks, NULL)) goto L0022;
                    if (ctx->cur == p) break;
                    continue;
                L0022:;
                    ctx->cur = p;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_4, 1, 6);
    ...
    L0021:;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_5, 1, 6);
    ...
    L0023:;
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_token_6, 1, 6);
                ...
                L0006:;
                    ...
                    }
                    {
                        ...
                        for (i = 0;; i++) {
                            const size_t p = ctx->cur;
                            const size_t n = chunk->thunks.len;
                            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_informal, &chunk->thunks, NULL)) goto L0008;
                            if (ctx->cur == p) break;
                            continue;
                        L0008:;
                            ctx->cur = p;
