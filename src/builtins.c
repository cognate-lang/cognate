...
{.name="*",                   .calltype=call, .argc=2, .args={number, number},      .returns=true, .rettype=number},
{.name="/",                   .calltype=call, .argc=2, .args={number, number},      .returns=true, .rettype=number},
{.name="max",                 .calltype=call, .argc=2, .args={number, number},      .returns=true, .rettype=number},
{.name="min",                 .calltype=call, .argc=2, .args={number, number},      .returns=true, .rettype=number},
...
{.name="fold",                .calltype=call, .argc=3, .args={block, any, list}, .returns=false, .stack=true},
