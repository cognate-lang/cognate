...
{.name="record", .type=func, .argc=1, .args={block}, .rets=true, .ret=record, .needs_stack=true},
{.name="get", .type=func, .argc=2, .args={symbol, record}, .rets=true, .ret=any},
{.name="has", .type=func, .argc=2, .args={symbol, record}, .rets=true, .ret=boolean},
{.name="stop"},
