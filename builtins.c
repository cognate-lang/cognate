...
{.name="when",                .calltype=call, .argc=2, .args={boolean, block},      .returns=false, .stack=true},
{.name="unless",              .calltype=call, .argc=2, .args={boolean, block},      .returns=false, .stack=true},
{.name="while",               .calltype=call, .argc=2, .args={block, block},        .stack=true},
{.name="times",               .calltype=call, .argc=2, .args={number, block},       .returns=false, .stack=true},
{.name="until",               .calltype=call, .argc=2, .args={block, block},        .stack=true},
...
{.name="either",              .calltype=call, .argc=2, .args={boolean, boolean}, .returns=true, .rettype=boolean},
{.name="both",                .calltype=call, .argc=2, .args={boolean, boolean}, .returns=true, .rettype=boolean},
{.name="one-of",              .calltype=call, .argc=2, .args={boolean, boolean}, .returns=true, .rettype=boolean},
...
{.name="number?",             .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
{.name="io?",                 .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
{.name="symbol?",             .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
...
{.name="list?",               .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
{.name="string?",             .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
{.name="block?",              .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
{.name="boolean?",            .calltype=call, .argc=1, .args={any},       .returns=true, .rettype=boolean},
...
{.name="join",                .calltype=call, .argc=1, .args={number},    .returns=true, .rettype=string, .stack=true},
...
{.name="map",                 .calltype=call, .argc=2, .args={block, list}, .returns=true, .rettype=list},
{.name="filter",              .calltype=call, .argc=2, .args={block, list}, .returns=true, .rettype=list, .stack=true},
{.name="for",                 .calltype=call, .argc=2, .args={list, block}, .returns=false, .stack=true},
...
{.name="take-while",          .calltype=call, .argc=2, .args={block, list}, .returns=true, .rettype=list},
...
{.name="all",                 .calltype=call, .argc=2, .args={block, list}, .returns=true, .rettype=boolean, .stack=true},
