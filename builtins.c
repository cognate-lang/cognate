...
{.name="drop", .type=stack_op, .stack_shuffle=&stack_drop},
{.name="twin", .type=stack_op, .stack_shuffle=&stack_twin},
{.name="triplet", .type=stack_op, .stack_shuffle=&stack_triplet},
{.name="swap", .type=stack_op, .stack_shuffle=&stack_swap},
