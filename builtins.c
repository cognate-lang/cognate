...
{.name="twin", .type=func, .argc=1, .args={any}, .rets=true, .ret=any, .needs_stack=true},
{.name="triplet", .type=func, .argc=1, .args={any}, .rets=true, .ret=any, .needs_stack=true},
{.name="swap", .type=func, .argc=2, .args={any,any}, .rets=true, .ret=any, .needs_stack=true},
